...
const views = {chatroom: {id: "chatroom", src: "./views/chatroom/chatroom.html"},
...
function set_var_successful_loggedin(value) {
  ...
  console.log("Index-Variable gesetzt:", window.successful_loggedin);
}
...
function switchView (id) {
    console.log(id)
    console.log(get_var_successful_loggedin());
    if(!get_var_successful_loggedin())
        return;
    ...
    switch(id){
        ...
        default:
            ...
            activeBtn = null;
            console.log("View-Id: '" + id + "' don't exist!")
            break;
    }

    //viewContainer.contentWindow.location.reload();
